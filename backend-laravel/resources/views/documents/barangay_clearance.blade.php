...
<body>
    ...
    <div class="content">
        <h2 style="text-align: center; color: #8b5cf6; margin-bottom: 30px;">BARANGAY CLEARANCE</h2>
        ...
        @if(!empty($request->notes))
            <p>This clearance is issued upon request for the purpose of <strong>{{ $request->notes }}</strong>.</p>
        @else
            <p>This clearance is issued upon request.</p>
        @endif
